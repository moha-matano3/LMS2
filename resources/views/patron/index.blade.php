      ...
      <div class="page-content">
        ...
        <main>
          <ul class="slider">
            ...
            <li class="item" style="background-image: url('{{ asset('book/1718799958.jpeg') }}')">
              <div class="content">
            ...
            <li class="item" style="background-image: url('{{asset('book/1718652345.jpg')}}')">
              <div class="content">
            ...
            <li class="item" style="background-image: url('{{asset('book/1718651768.webp')}}">
              <div class="content">
